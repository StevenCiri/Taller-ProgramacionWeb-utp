    ...
    <section id="purchasing-description">
        <div class="product-container">
            <div id="product-image" class="product-image">
                <img id="zoomImage" src="../media/Productos/torta-naruto.png" alt="torta compromiso">
            </div>
            <div class="product-details">
                <h2>Torta de Naruto: "Ninja Dulce de la Aldea Oculta"</h2>
                <p>Embárcate en una deliciosa aventura ninja con nuestra increíble Torta Temática de Naruto, una creación que rinde homenaje al carismático ninja y sus compañeros de la Aldea Oculta de la Hoja.

                    La base de la torta, esculpida con maestría, toma la forma de los elementos icónicos del universo Naruto. Desde la cabeza del astuto zorro Kurama hasta detalles de shurikens y kunais, cada rincón de la torta evoca la esencia del mundo ninja.

                    El exterior de la torta está envuelto en un glaseado vibrante que refleja la paleta de colores distintiva de Naruto. Detalles personalizados como el símbolo de la Hoja y pequeñas figuras de los personajes principales adornan la creación, añadiendo autenticidad y un toque lúdico.</p>
            </div>
        </div>
    </section>
    ...
    <div class="comentarios">
        <section>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <input type="hidden" name="id_pagina" value="26">
