    ...
    <section id="purchasing-description">
        <div class="product-container">
            <div id="product-image" class="product-image">
                <img id="zoomImage" src="../media/Productos/Galleta con Chispas de Chocolate.png" alt="galletas">
            </div>
            <div class="product-details">
                <h2>Galletas con Chispas de Chocolate</h2>
                <p>Nuestras galletas con chispas de chocolate son una oda a la indulgencia y al placer. Con cada
                    mordisco, te sumergirás en un mundo de sabores y texturas que harán que tus sentidos se despierten.
                    Estas galletas son la combinación perfecta de crujientes y suaves, con la dulzura reconfortante del
                    chocolate.</p>
            </div>
        </div>
    </section>
