    ...
    <section id="purchasing-description">
        <div class="product-container">
            <div id="product-image" class="product-image">
                <img id="zoomImage" src="../media/Productos/torta-hellokity.png" alt="torta compromiso">
            </div>
            <div class="product-details">
                <h2>Torta de Hello Kitty: "Magia en Cada Bocado"</h2>
                <p>¡Celebra la dulzura y la encantadora personalidad de Hello Kitty con nuestra deliciosa Torta de Hello Kitty, una creación que captura la esencia juguetona y adorable de este icónico personaje!

                    La base de la torta, cuidadosamente elaborada, toma la forma de la querida Hello Kitty. Con capas suaves de bizcocho que se mezclan con rellenos deliciosos como crema de vainilla o fresa, cada porción es una experiencia sabrosa que te transporta al mundo mágico de Hello Kitty.

                    El exterior de la torta está envuelto en un glaseado suave y vibrante que refleja la paleta de colores característica de Hello Kitty. Detalles encantadores, como lazos en fondant y pequeñas flores comestibles, añaden un toque de sofisticación y ternura a la decoración.</p>
            </div>
        </div>
    </section>
    ...
    <div class="comentarios">
        <section>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <input type="hidden" name="id_pagina" value="21">
