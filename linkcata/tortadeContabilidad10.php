    ...
    <section id="purchasing-description">
        <div class="product-container">
            <div id="product-image" class="product-image">
                <img id="zoomImage" src="../media/Productos/torta-contabilidad.png" alt="torta contabilidad">
            </div>
            <div class="product-details">
                <h2>Torta de Contabilidad</h2>
                <p>Celebra los logros financieros y el arte de los números con nuestra extraordinaria Torta de Contabilidad, una creación deliciosa diseñada para cautivar a los amantes de las finanzas y honrar los hitos en el mundo de los negocios.

                    La base de la torta, expertamente horneada, simboliza la estabilidad y precisión requeridas en el campo de la contabilidad. Con capas alternas de sabores exquisitos, desde un rico chocolate que representa la solidez financiera hasta una vainilla suave que personifica la diversidad de transacciones, cada porción es una mezcla perfecta de dulzura y profesionalismo.</p>
            </div>
        </div>
    </section>
    ...
    <div class="comentarios">
        <section>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <input type="hidden" name="id_pagina" value="10">
