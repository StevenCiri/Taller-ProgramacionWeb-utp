    ...
    <section id="purchasing-description">
        <div class="product-container">
            <div id="product-image" class="product-image">
                <img id="zoomImage" src="../media/Productos/torta-blackpink.png" alt="torta blackpink">
            </div>
            <div class="product-details">
                <h2>Torta de Blackpink</h2>
                <p>¡Sumérgete en el dulce universo de la música pop con nuestra espectacular Torta de Blackpink! Inspirada en el fascinante mundo de este icónico grupo de K-pop, esta deliciosa creación combina el sabor exquisito con un toque de glamour y energía vibrante.

                    La base de la torta está compuesta por capas suaves y esponjosas que representan la armonía perfecta entre las integrantes de Blackpink. Cada capa es una melodía de sabores exquisitos, desde vainilla clásica hasta chocolate decadente, fusionando lo tradicional con lo moderno de una manera única.
