    ...
    <section id="purchasing-description">
        <div class="product-container">
            <div id="product-image" class="product-image">
                <img id="zoomImage" src="../media/Productos/torta-u2.png" alt="torta compromiso">
            </div>
            <div class="product-details">
                <h2>Torta Temática de Universitario de Deportes: "Euforia Crema en Cada Rincón"</h2>
                <p>Deleita tus sentidos con nuestra excepcional Torta Temática de Universitario de Deportes, una creación que irradia la emoción y la lealtad al equipo crema en cada rincón sabroso.

                    La base de la torta presenta una armonía cautivadora de colores, recreando con precisión los tonos crema y granate emblemáticos del Club Universitario de Deportes. Cada capa de bizcocho, tierna y deliciosa, se sumerge en los colores vibrantes que encienden la pasión futbolística.

                    El exterior de la torta está meticulosamente decorado con elementos que evocan la grandeza del fútbol. Un balón de fútbol comestible, modelado con detalle, adorna la cima de la torta, capturando la esencia del juego. Puedes personalizar el diseño del balón con el escudo de Universitario de Deportes para un toque distintivo.</p>
            </div>
        </div>
    </section>
    ...
    <div class="comentarios">
        <section>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <input type="hidden" name="id_pagina" value="33">
