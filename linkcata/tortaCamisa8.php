    ...
    <section id="purchasing-description">
        <div class="product-container">
            <div id="product-image" class="product-image">
                <img id="zoomImage" src="../media/Productos/torta-camisa.png" alt="torta camisa">
            </div>
            <div class="product-details">
                <h2>Torta en Forma de Camisa de Oficial</h2>
                <p>¡Celebra un momento especial con nuestra extraordinaria Torta en Forma de Camisa de Oficial! Esta deliciosa obra maestra combina la elegancia y el detalle de un uniforme militar con la dulzura irresistible de una torta gourmet.

La base de la torta está cuidadosamente elaborada para imitar la textura y la forma de una camisa de oficial. Cada pliegue y botón es modelado con precisión, creando una obra de arte comestible que rinde homenaje a la disciplina y la distinción asociadas con el servicio militar.</p>
            </div>
        </div>
    </section>
    ...
    <div class="comentarios">
        <section>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <input type="hidden" name="id_pagina" value="8">
